...
class ExcelVisualizer:
    def __init__(self, root):
        self.root = root
        root.state('zoomed')
        self.root.title("Cell Utilization Viewer V1.11")
        self.tree = None
        self.df = None
    ...
    def create_widgets(self):
        ...
        # self.export_all_btn = tk.Button(frame, text="Export All Over Threshold Charts", bg="#E4AA7C", fg="white", font=('Arial', 11), command=self.export_all_over_threshold, state="disabled")
    ...
    def populate_tree(self):
        ...
        for (sel_name, siteid, sectorid), group in grouped:
            ...
            # half_data = group.iloc[int(len(group) / 1):]

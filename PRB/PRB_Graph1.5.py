...
class ExcelVisualizer:
    ...
    def create_widgets(self):
        ...
        # Export PDF Button
        self.export_btn = tk.Button(frame, text="Export Chart to PDF", bg="#666", fg="white", font=('Arial', 11), command=self.export_to_pdf, state="disabled")
        self.export_btn.pack(fill="x", pady=5, padx=10)
    ...
    def plot_charts(self, data):
        ...
        self.last_figure = fig  # Save figure for PDF export

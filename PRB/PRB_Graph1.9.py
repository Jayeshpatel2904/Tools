...
class ExcelVisualizer:
    def __init__(self, root):
        self.root = root
        root.state('zoomed')
        self.root.title("Cell Utilization Viewer V1.9")
        self.tree = None
        self.df = None
    ...
    def load_file(self):
        ...
        try:
            ...
            # percent_input = simpledialog.askfloat("Percentage Above Threshold", "Enter percentage of data points (e.g. 5 for 5%)", minvalue=0.0, maxvalue=100.0, initialvalue=5)
